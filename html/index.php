...
var httpPath='http://58.22.120.20:7080';
        ...
        <div id="content_index">
            ...
            <table width="444" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td width="220"> <input class="num" type="text" name="username" id="username"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><a class="a_height" id="wjmm" name="wjmm" href=""  target="_blank">忘记密码？</a></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <input class="btn btn_small" type="submit" value="登 录" id="submit"/>
...
{
header("location:/load/upgrading.html");
}
