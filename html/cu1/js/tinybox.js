    ...
    return{
            ...
            if (u) {
                ...
                x.onreadystatechange = function () {
                    if (x.readyState == 4 && x.status == 200) {
						//alert('resultText:'+x.responseText);
                        TINY.box.psh(x.responseText, w, h, a);
						//alert(document.getElementById('showError').innerHTML);
                    }
                };
                x.open('GET', c, 1);
        ...
        twsize:function (e, w, wo, wd, h, ho, hd, s) {
            ...
            if (ow == w && oh == h) {
                ...
                if(document.getElementById("failMsg")){
                	document.getElementById("failMsg").innerHTML = document.getElementById("errorMsg").value;
                }
            } else {
                if (ow != w) {
